...
export default function RegisterPage() {
  ...
  const [erroSenhaText, setErroSenhaText] = useState(
  ...
  return (
    <div className="min-h-[calc(100vh-32px)] flex items-center justify-center">
      <Snackbar
        open={open}
          ...
          <CardContent>
            ...
            <form onSubmit={handleRegistro} className="flex flex-col gap-4">
              ...
              >
                ...
                />
                {erroSenha && <FormHelperText>{erroSenhaText}</FormHelperText>}
              </FormControl>
